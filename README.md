...
O repositório está organizado de forma modular e limpa para garantir a reprodutibilidade dos experimentos:
...
├── src/
│   └── models/
│       ├── naive_bayes.py             # Modelo probabilístico base
...
Certifique-se de ter o scikit-learn e o pandas instalados. Para rodar qualquer modelo e visualizar sua respectiva matriz de confusão no terminal, execute o comando a partir da raiz do projeto:
